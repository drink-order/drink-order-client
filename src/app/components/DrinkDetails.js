...
const DrinkDetails = ({ drink, onAddToCart }) => {
  const [quantity, setQuantity] = useState(1);
  const basePrice = drink.price; // Use the price from the drink object
  const totalPrice = (basePrice * quantity).toFixed(2);
    ...
    <div className="max-w-lg mx-auto p-4">
      <div className="bg-white shadow-lg rounded-lg sticky top-4">
        ...
        <div className="p-4">
          ...
          <p className="text-gray-600 text-sm mb-4">${drink.price.toFixed(2)}/cup</p>

          {/* Size Options */}
          <div className="mb-4">
            <h3 className="text-sm font-medium text-gray-800 mb-2">SIZE</h3>
            <div className="flex space-x-4">
              {/* Replace the hardcoded options with dynamic options if available in the `drink` object */}
              <label className="flex items-center space-x-2">
                <input
                  type="radio"
                  name="size"
          ...
          <div className="mb-4">
            <h3 className="text-sm font-medium text-gray-800 mb-2">SWEETNESS</h3>
            <div className="space-y-2">
              {/* Add options dynamically or use static options */}
              <label className="flex items-center space-x-2">
                <input type="radio" name="sweetness" className="text-orange-500 focus:ring-0" />
                <span className="text-gray-700 text-sm">Normal Sweet</span>
              </label>
          ...
          <div className="mt-4 flex items-center space-x-4">
            ...
            <button
              className="flex-1 bg-orange-500 text-white text-lg font-medium py-2 rounded-lg hover:bg-orange-600"
